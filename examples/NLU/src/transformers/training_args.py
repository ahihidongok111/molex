...
class TrainingArguments:
    ...
    ######## Additional Params #######
    gate_lr: float = field(default=5e-5, metadata={"help": "The initial learning rate for AdamW for gate."})
    gate_weight_decay: float = field(default=0.0, metadata={"help": "Weight decay for AdamW if we apply some for gate."})
    g_balance: float = field(default=0.01, metadata={"help": "Weight for load balancing loss."})
    ##################################
    ...
    local_rank: int = field(default=os.environ['LOCAL_RANK'], metadata={"help": "For distributed training: local_rank"})
